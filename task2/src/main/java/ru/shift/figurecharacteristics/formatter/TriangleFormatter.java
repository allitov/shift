...
public class TriangleFormatter implements FigureFormatter<Triangle> {
    ...
    public String format(Triangle triangle) {
        ...
        return "Тип фигуры: " + triangle.getName() + LINE_SEPARATOR +
                ...
                "Сторона a: " + DECIMAL_FORMAT.format(a) + SPACE + UNITS + "; угол: " + DECIMAL_FORMAT.format(triangle.getSideToAngleMap().get(a)) + " градусов" + LINE_SEPARATOR +
                "Сторона b: " + DECIMAL_FORMAT.format(b) + SPACE + UNITS + "; угол: " + DECIMAL_FORMAT.format(triangle.getSideToAngleMap().get(b)) + " градусов" + LINE_SEPARATOR +
                "Сторона c: " + DECIMAL_FORMAT.format(c) + SPACE + UNITS + "; угол: " + DECIMAL_FORMAT.format(triangle.getSideToAngleMap().get(c)) + " градусов";
    }
}
